    ...
    */
    $STATIC_METHOD_TYPES = [
        new \Illuminate\Contracts\Container\Container => [
            ...
            'pierresilva.repository.listener' instanceof \pierresilva\Repository\Listeners\RepositoryEventListener,
            ...
            'command.module.disable' instanceof \pierresilva\Modules\Console\Commands\ModuleDisableCommand,
            'command.module.enable' instanceof \pierresilva\Modules\Console\Commands\ModuleEnableCommand,
            'command.module.list' instanceof \pierresilva\Modules\Console\Commands\ModuleListCommand,
            'command.module.migrate' instanceof \pierresilva\Modules\Console\Commands\ModuleMigrateCommand,
            'command.module.migrate.refresh' instanceof \pierresilva\Modules\Console\Commands\ModuleMigrateRefreshCommand,
            'command.module.migrate.reset' instanceof \pierresilva\Modules\Console\Commands\ModuleMigrateResetCommand,
            'command.module.migrate.rollback' instanceof \pierresilva\Modules\Console\Commands\ModuleMigrateRollbackCommand,
            'command.module.optimize' instanceof \pierresilva\Modules\Console\Commands\ModuleOptimizeCommand,
            'command.module.seed' instanceof \pierresilva\Modules\Console\Commands\ModuleSeedCommand,
            'command.make.module' instanceof \pierresilva\Modules\Console\Generators\MakeModuleCommand,
            'command.make.module.controller' instanceof \pierresilva\Modules\Console\Generators\MakeControllerCommand,
            'command.make.module.middleware' instanceof \pierresilva\Modules\Console\Generators\MakeMiddlewareCommand,
            'command.make.module.migration' instanceof \pierresilva\Modules\Console\Generators\MakeMigrationCommand,
            'command.make.module.model' instanceof \pierresilva\Modules\Console\Generators\MakeModelCommand,
            'command.make.module.policy' instanceof \pierresilva\Modules\Console\Generators\MakePolicyCommand,
            'command.make.module.provider' instanceof \pierresilva\Modules\Console\Generators\MakeProviderCommand,
            'command.make.module.request' instanceof \pierresilva\Modules\Console\Generators\MakeRequestCommand,
            'command.make.module.seeder' instanceof \pierresilva\Modules\Console\Generators\MakeSeederCommand,
            'pierresilva\Modules\Contracts\Repository' instanceof \pierresilva\Modules\Repositories\LocalRepository,
            'modules' instanceof \pierresilva\Modules\Modules,
            'sentinel' instanceof \pierresilva\Sentinel\Sentinel,
            'themes' instanceof \pierresilva\Themes\Themes,
