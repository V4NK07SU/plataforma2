...
/**
 * @resource EvaluationCommitmentResponse
 *
 * Relaciones de la tabla, evaluation_commitments_responses.
 *
 * @author Danny Rojas Reyes, @rojasknight
 *
 */

class EvaluationCommitmentResponse extends Model
{
    use SoftDeletes;

    protected $table = 'evaluation_commitments_responses';

    protected $primaryKey = 'id';

    protected $fillable = [
        'evaluation_id', 'commitment_id', 'answer_id', 'evaluated_id', 'evaluator_id', 'rol_id',
    ];
