...
(function() {
    ...
    function HealthDimensionIndexCtrl($scope, $window, $state,  ToastService, DialogService, $http, HealthDimensionSrv) {
        ...
        $scope.editDimension = function (id) {
            $state.go('health-record/dimensions/edit', { id: id });
        };

        
        //create
       $scope.new = function () {
            $state.go('health-record/dimensions/create');
        };
    ...
    function HealthDimensionCreateCtrl($scope, dimensions_categories) {
        $scope.formUrl = THEME_URL + '/app/modules/health-record/dimensions/views/form.html';
         ...
         $scope.save = function() {  
            ...
            HealthDimensionSrv.save($scope.dimensions,
                function(response) {
                    ...
                    ToastService.success(response.message);
                    $state.go('health-record/dimensions');
                }, function(response) {
                    console.log(response);
