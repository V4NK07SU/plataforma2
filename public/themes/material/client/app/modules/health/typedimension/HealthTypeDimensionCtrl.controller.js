...
(function() {
    ...
    angular.module('app.modules.health.typedimension')
        ...
        .controller('HealthTypeDimensionShowCtrl', ['$scope', '$window', HealthTypeDimensionShowCtrl])
        .controller('HealthTypeDimensionCreateCtrl', ['$scope', '$window', '$stateParams', 'HealthTypeDimensionSrv', 'ToastService', '$state', 'HealthTypeSrv', HealthTypeDimensionCreateCtrl])
        .controller('HealthTypeDimensionEditCtrl', [
            '$scope', '$window', '$stateParams', 'HealthTypeDimensionSrv', 'ToastService', '$state', 'typedimension', 'HealthTypeSrv',
            HealthTypeDimensionEditCtrl])
        .controller('HealthTypeDimensionFormCtrl', ['$scope', '$window', HealthTypeDimensionFormCtrl]);
    ...
    function HealthTypeDimensionIndexCtrl($scope, $window, $state, HealthTypeDimensionSrv, ToastService, DialogService,$http) {
        ...
        $scope.edittypedimension = function (id) {
            $state.go('health/typedimension/edit', { id: id });
        };

        
        //create
       $scope.new = function () {
            $state.go('health/typedimension/create');
        };
     ...
     * @constructor
     */
    function HealthTypeDimensionCreateCtrl($scope, $window, $stateParams, HealthTypeDimensionSrv, ToastService, $state, HealthTypeSrv) {
        $scope.formUrl = THEME_URL + '/app/modules/health/typedimension/views/form.html';

        $scope.HealthTypeSrv = HealthTypeSrv;
        /**$scope.types = {};
     ...
     * @constructor
     */
    function HealthTypeDimensionEditCtrl($scope, $window, $stateParams, HealthTypeDimensionSrv, ToastService, $state, typedimension, HealthTypeSrv) {
        $scope.formUrl = THEME_URL + '/app/modules/health/typedimension/views/form.html';
        $scope.typedimension = typedimension;
        $scope.types = types;
        /**$scope.types = {};
        $scope.types = HealthTypeSrv.get();
        console.log($scope.types);*/
     ...
     * @constructor
     */
    function HealthTypeDimensionFormCtrl($scope, $window, $stateParams, HealthTypeDimensionSrv, ToastService, $state, typedimension, HealthTypeSrv) {
        $scope.formUrl = THEME_URL + '/app/modules/health/typedimension/views/form.html';
