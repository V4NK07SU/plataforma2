(function() {
    ...
    .controller('PollQuestionEditCtrl', ['$scope', '$window', '$stateParams', 'pollQuestionType', 'PollQuestionTypeSrv', 'ToastService', '$state', PollQuestionEditCtrl]);
    ...
    function PollQuestionEditCtrl($scope, $window, $stateParams, pollQuestionType, PollQuestionTypeSrv, ToastService, $state) {
        $scope.formUrl = THEME_URL + '/app/modules/polls/poll-question-type/views/form.html';
