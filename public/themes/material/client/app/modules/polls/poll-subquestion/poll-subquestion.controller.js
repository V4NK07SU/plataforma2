...
=======
    ...
    angular.module('app.modules.polls.poll-subquestion')
        .controller('PollSubquestionCtrl', ['$scope', '$window', PollSubquestionCtrl])
        .controller('PollSubquestionIndexCtrl', ['$scope', '$window', PollSubquestionIndexCtrl])
        .controller('PollSubquestionFormCtrl', ['$scope', '$window', PollSubquestionFormCtrl]);
    ...
    function PollSubquestionIndexCtrl($scope, $window) {
        $scope.list = [{
                id: '1',
                question: 'Pregunta #1',
                title: 'Titulo 1',
