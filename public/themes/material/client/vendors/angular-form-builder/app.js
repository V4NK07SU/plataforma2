! function(t) {
    ...
    function(t) {
        ...
        function e(t) {
            function e(e, i, o, n) {
                var r = n._getItemTemplate(o.type),
                    a = t(r)(e);
                i.append(a), n.init()
            }
            var o = {
        ...
        e.$inject = ["$compile"], i.$inject = ["$attrs", "Utils"], t.module("angularMaterialFormBuilder").directive("formItem", e), i.prototype.init = function() {
            ...
            var e = '<div class="form-item-container"><div class="form-item-actions"><md-input-container><label>Variable de Riesgo:</label><md-select ng-model="FormItem.item.props.riskVar"><md-option ng-repeat="riskVar in FormItem.item.riskVars" value="{{riskVar.id}}">{{riskVar.title}}</md-option></md-select></md-input-container><md-button class="md-button" ng-if="FormItem.Attrs.onDelete" ng-click="FormItem.deleteClicked()"> <i class="material-icons small">delete</i></md-button><md-button class="md-button" ng-if="FormItem.Attrs.onUp" ng-click="FormItem.onUp({item: FormItem.item, index: FormItem.index()})"> <i class="material-icons small">arrow_drop_up</i></md-button><md-button class="md-button" ng-if="FormItem.Attrs.onDown" ng-click="FormItem.onDown({item: FormItem.item, index: FormItem.index()})"> <i class="material-icons small">arrow_drop_down</i></md-button></div><div><md-input-container><label>Pregunta</label><input ng-model="FormItem.item.props.title"/></md-input-container><md-input-container><label>Descripción</label><input ng-model="FormItem.item.props.helpText" /></md-input-container></div>',
                i = '<md-input-container><md-checkbox ng-model="FormItem.item.config.required">Requerido</md-checkbox></md-input-container></div>';
